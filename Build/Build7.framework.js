...
function _HatchEgg(account_id) {
 var returnStr = window.Unity_HatchEgg(account_id);
 return buffer;
}
...
function _MintEgg(account_id) {
 var returnStr = window.Unity_MintEgg(account_id);
}

function _RequestAllMonstreInfo(account_id) {
 window.Unity_RequestAllMonstreInfo(account_id);
}
...
function _getOwnerInfo(owner_id) {
 window.alert("getOwnerInfo");
 var returnStr = window.myFunction(owner_id);
...
var asmLibraryArg = {
 ...
 "MintEgg": _MintEgg,
 "RequestAllMonstreInfo": _RequestAllMonstreInfo,
...
var dynCall_jijffffjji = Module["dynCall_jijffffjji"] = createExportWrapper("dynCall_jijffffjji");
